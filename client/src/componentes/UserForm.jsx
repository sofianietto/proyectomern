    ...
    return (
        <Formik
            initialValues={{
                email: '',
                contraseña: '',
                ...(formType === 'registro' && { nombre: '', apellido: '', confirmarcontraseña: '' }),
            }}
                ...
                <Form>
                    ...
                    {formType === 'registro' && (
                        <>
                            ...
                            <div className="mb-3">
                                <Field type="text" name="apellido" className="form-control" placeholder="Apellido" />
                    ...
                    <div className="mb-3">
                        <Field type="password" name="contraseña" className="form-control" placeholder="contraseña" />
                        <ErrorMessage name="contraseña" component="div" className="text-danger" />
                    </div>
                    {formType === 'registro' && (
                        <div className="mb-3">
                            <Field type="password" name="confirmcontraseña" className="form-control" placeholder="Confirmar contraseña" />
                            <ErrorMessage name="confirmcontraseña" component="div" className="text-danger" />
                        </div>
                    )}
